...
<?php
session_start();
if (!isset($_SESSION['librarian_login'])){//login.php
    header('Location: login.php');
    exit();
}

$librarian_login_email = $_SESSION['librarian_login'];//login.php
$query = "SELECT * FROM librarian WHERE email='$librarian_login_email'";
$data = mysqli_query($conn, $query);
//var_dump($data);
//exit();
$librarian_info = mysqli_fetch_assoc($data);
//var_dump($librarian_info);
//exit();
    ...
    <div class="page-header">
        ...
        <div class="rightside-header">
            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    <div class="user-photo">
                        <img alt="profile photo" src="<?= $librarian_info['image']; ?>" />
                    </div>
                    <div class="user-info">
                        <span class="user-name"><?= ucwords($librarian_info['firstname'].' '.$librarian_info['lastname']); ?></span>
                        <span class="user-profile"><?= ucwords($librarian_info['status']); ?></span>
                    </div>
            ...
            <div class="header-section">
                <a href="logout.php" data-toggle="tooltip" data-placement="left" onclick="return confirm('Hi, <?= ucwords($_SESSION['librarian_lname']);?>. Are You Sure To LogOut')" title="Hi, <?= ucwords($_SESSION['librarian_username']); ?> ! Are You Sure To LogOut.">
                ...
                <div class="nano-content">
                    <nav>
                        <ul class="nav nav-left-lines" id="main-nav">
                            ...
                            <li class="<?= $page_active == 'students.php' ? 'active-item' : '';?>">
                                <a href="students.php">
                            ...
                            <li class="has-child-item close-item <?= $page_active == 'add_book.php' ? 'open-item' : '';?><?= $page_active == 'manage_book.php' ? 'open-item' : '';?><?= $page_active == 'selim_book.php' ? 'open-item' : '';?>">
                                <!--                            <li class="has-child-item close-item --><?//= $page_active == 'add_book.php' || 'manage_book.php' || 'selim_book.php' ? 'open-item' : '';?><!--">-->
                                <a><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a>
                                <ul class="nav child-nav level-1">
                                    <li class="<?= $page_active == 'add_book.php' ? 'active-item' : '';?>"><a href="../librarian/add_book.php">Add Book</a></li>
                                    <li class="<?= $page_active == 'manage_book.php' ? 'active-item' : '';?>"><a href="../librarian/manage_book.php">Manage Book</a></li>
                                    <li class="<?= $page_active == 'selim_book.php' ? 'active-item' : '';?>"><a href="../librarian/selim_book.php">Selim Book</a></li>
                                </ul>
                            </li>


                            <li class="<?= $page_active == 'issue_book.php' ? 'active-item' : '';?>">
                            ...
                            <li class="<?= $page_active == 'return_book.php' ? 'active-item' : '';?>">

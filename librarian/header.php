            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    <div class="user-photo">
                        <img alt="profile photo" src="<?= $_SESSION['librarian_image']; ?>" />
                    </div>
                    <div class="user-info">
                        <span class="user-name"><?= ucwords($_SESSION['librarian_username']); ?></span>
                        <span class="user-profile"><?= ucwords($_SESSION['librarian_lname']); ?></span>
                    </div>
